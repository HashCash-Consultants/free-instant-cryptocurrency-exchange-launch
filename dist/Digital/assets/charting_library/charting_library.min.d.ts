...
export declare type TableElementFormatFunction = (inputs: TableFormatterInputs) => string | $;
...
export interface AccountManagerInfo {
	...
	contextMenuActions?(activePageActions: ActionMetaInfo[]): Promise<ActionMetaInfo[]>;
}
