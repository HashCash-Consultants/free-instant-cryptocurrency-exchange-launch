...
@Component({
  selector: 'app-options-depth-chart',
  templateUrl: './options-depth-chart.component.html',
  styleUrls: ['./options-depth-chart.component.css']
})
export class OptionsDepthChartComponent implements OnInit {
