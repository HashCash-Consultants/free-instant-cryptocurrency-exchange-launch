...
declare var am5;
declare var am5themes_Animated;
declare var am5xy;
...
export class DepthChartComponent implements OnInit {
  ...
  @Input() askBidDataInputstrm :any = {};
  askDataStream: any;
  bidDataStream: any;
  askDataStreamArray: any;
  newArray: any[];
  bidDataStreamArray: any;
  newArraybid: any[];
  dataAsks: any[][];
  dataBids: any[][];
  buyingCode: string;
  ...
  constructor(private zone: NgZone,
    ...
    // this.buyingCode =   localStorage.getItem('buying_crypto_asset')
    // this.sellingCode =   localStorage.getItem('selling_crypto_asset')


    // console.log('buyingCode',this.buyingCode);
    // console.log('sellingCode',this.sellingCode);
...
this.askBidDataInputstrm = this.askBidDataInputstrm

// console.log('test daata from socket',this.askBidDataInputstrm);

try{
  if(this.askBidDataInputstrm == undefined || this.askBidDataInputstrm == null){
    // console.log('nothing');
    
  }
  else{
    this.askDataStream = this.askBidDataInputstrm.ask;
    this.bidDataStream = this.askBidDataInputstrm.bid;
  
    // console.log('askStream from websocket',this.askDataStream);
    // console.log('bidStream from websocket',this.bidDataStream);
  
    this.askDataStreamArray = this.askDataStream.map(obj => Object.values(obj));
    this.bidDataStreamArray = this.bidDataStream.map(obj => Object.values(obj));
  
    this.newArray = []
    this.newArraybid = []
    for(var i=0 ;i<this.askDataStreamArray.length;i++){
      var numberArray = this.askDataStreamArray[i].map(Number);
      this.newArray.push(numberArray)
     
  
    }
  
    for(var i=0 ;i<this.bidDataStreamArray.length;i++){
      var numberArrayBid = this.bidDataStreamArray[i].map(Number);
      this.newArraybid.push(numberArrayBid)
  
    }
  
    // console.log('stream ask array',this.newArray);
    // console.log('stream bid array',this.newArraybid);
  
   
    let storeBidDataInLocalStorage = JSON.stringify(this.newArraybid)
    let storeAskDataInLocalStorage = JSON.stringify(this.newArray)
  
    localStorage.setItem('bidDataForDepthChart',storeBidDataInLocalStorage)
    localStorage.setItem('askDataForDepthChart',storeAskDataInLocalStorage)
    //console.log('Length of ask',storeAskDataInLocalStorage)
  
  }
}
catch{

  // console.log('no data found in depth');
  ...
  ngOnInit() {
    ...
    setTimeout(() => {
        ...
        am5.ready(function() {
          ...
          // xAxis.renderer.labels.template.fill = am5.color('#000000');
          ...
          if(localStorage.getItem('buying_crypto_asset') == 'btc' && localStorage.getItem('selling_crypto_asset') == 'inr'){
          ...
          // yAxis.renderer.labels.template.fill = am5.color('#000000');
          // Add series
          ...
          function loadData() {
            ...
            // }).catch(function() {
             ...
             // this.zone.run(() => { 
             // let newArray = [ [ "0.07070", 1.0 ], [ "0.07071", 1.654 ], [ "0.07076", 0.61 ], [ "0.07077", 1.2 ], [ "0.07093", 0.584 ], [ "0.07095", 0.005 ], [ "0.07098", 0.01 ], [ "0.07100", 0.653 ], [ "0.07105", 6.0 ], [ "0.07107", 0.002 ], [ "0.07110", 0.022 ], [ "0.07113", 0.001 ], [ "0.07115", 0.001 ],