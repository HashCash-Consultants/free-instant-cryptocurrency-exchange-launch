...
@Component({
    ...
    templateUrl: './derivative-tvchartcontainer.component.html',
    styleUrls: ['./derivative-tvchartcontainer.component.css']
})
export class DerivativeTvchartcontainerComponent implements OnInit {
    ...
    private _symbol: ChartingLibraryWidgetOptions['symbol'] = localStorage.getItem("selected_derivative_asset_pair");
    ...
    constructor(public chartSocket: DerivativeTvChartWebSocketAPI, private http: HttpClient, public data: CoreDataService) { }
    ...
    ngDoCheck() {
     ...
     this.changeTheme(); */
        ...
        let isAssetPairChangedRecently = localStorage.getItem('isAssetPairChangedRecentlyFutures')
        if (isAssetPairChangedRecently == 'true') {
            ...
            localStorage.setItem('isAssetPairChangedRecentlyFutures', 'false')
            //this._tvWidget = null;
            this.assetPair = localStorage.getItem("selected_derivative_asset_pair")
            this.assetPairName = localStorage.getItem("selected_derivative_asset_pair_name")
            this._symbol = this.assetPair;
