...
@Component({
  selector: 'app-derivative-dashboard',
  templateUrl: './derivative-dashboard.component.html',
  styleUrls: ['./derivative-dashboard.component.css']
})
export class DerivativeDashboardComponent implements OnInit {
  alertType: any;
  alertMsg: any;
  chart: any = true;
  orderbook: any = true;
  ...
  constructor(  public data: CoreDataService,
    ...
    public tvChartContainerComponent: DerivativeTvchartcontainerComponent,
