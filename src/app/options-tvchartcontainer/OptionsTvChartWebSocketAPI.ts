...
export class OptionsTvChartWebSocketAPI {
   ...
   currentMessage = this.messageSource.asObservable();
    ...
    webSocketEndPoint: string = 'https://options-socket.paybito.com:2443/OptionChartStream/ws';
    ...
    subscribe() {
        ...
        let isUnsubscribeOccured = localStorage.getItem('isUnsubscribeOccuredChart')
          ...
          const req = {
            ...
            "contract": localStorage.getItem("selected_options_asset_pair"),
